...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, TicketRowComponent, TicketRowSkeletonComponent],
    template: `
      <div class="flex flex-col h-full overflow-y-auto">
        ...
        <!-- Empty state -->
          ...
          <div class="flex flex-col items-center justify-center flex-1 py-16 px-6 text-center text-gray-400">
            ...
            <p class="text-sm font-medium text-gray-600">No hay tickets aquí</p>
            <p class="text-xs mt-1">{{ emptySubtext }}</p>
          </div>
