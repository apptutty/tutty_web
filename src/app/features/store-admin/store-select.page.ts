    ...
    <div class="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
      <div class="w-full max-w-3xl">
        ...
        <div class="text-center mb-10">
          ...
          <h1 class="text-2xl font-bold text-gray-900">Selecciona tu comercio</h1>
          <p class="text-gray-500 mt-2">Tienes {{ approvedStores().length }} comercios vinculados. ¿Con cuál deseas trabajar?</p>
        </div>
